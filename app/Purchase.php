...
class Purchase extends Model
{
    ...
    public function qc()
    {
        return $this->hasMany(QualityControl::class, 'id_pembelian')
            ->select('jumlah_pembelian_detail', 'qc.id_barang', 'id', 'barang.nama_barang', 'qc.id_satuan_barang', 'nama_satuan_barang', 'tanggal_qc', 'status_qc', 'reason', 'sg_pembelian_detail', 'be_pembelian_detail', 'ph_pembelian_detail', 'warna_pembelian_detail', 'keterangan_pembelian_detail')
