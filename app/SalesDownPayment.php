...
class SalesDownPayment extends Model
{
    ...
    protected $fillable = [
        'id_cabang', 'kode_uang_muka_penjualan', 'tanggal', 'id_permintaan_penjualan', 'id_mata_uang', 'rate', 'nominal', 'total', 'catatan', 'id_slip', 'void', 'void_user_id', 'user_created', 'dt_created', 'user_modified', 'dt_modified', 'konversi_nominal', 'dpp', 'ppn', 'ppn_uang_muka_penjualan',
    ];
