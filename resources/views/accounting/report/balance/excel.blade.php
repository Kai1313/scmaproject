    ...
    <table>
        <tr>
            @if($data["type"] == 'recap' || $data["type"] == 'awal')
                <th colspan="4" style="text-align: center;font-size: 16;"><b>Export Excel Report Neraca {{ ucfirst($data["type"]) }}</b></th>
            @else
                <th colspan="5" style="text-align: center;font-size: 16;"><b>Export Excel Report Neraca {{ ucfirst($data["type"]) }}</b></th>
            @endif
        </tr>
        <tr>
