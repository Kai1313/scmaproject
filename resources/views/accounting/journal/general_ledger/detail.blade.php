                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <p class="nomarg">
                                            {{ date('d-m-Y', strtotime($data_jurnal_header->tanggal_jurnal)) }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <p class="nomarg">{{ $data_jurnal_header->kode_cabang }} -
                                            {{ $data_jurnal_header->nama_cabang }}</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <p class="nomarg">{{ $data_jurnal_header->kode_slip }} -
                                                {{ $data_jurnal_header->nama_slip }}</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                            ...
                            <div class="col-md-6">
                                ...
                                @if (($data_jurnal_header->no_giro != null && $data_jurnal_header->jenis_jurnal == 'PG') ||
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <p class="nomarg">
                                                {{ date('d-m-Y', strtotime($data_jurnal_header->tanggal_giro)) }}</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <p class="nomarg">
                                                {{ date('d-m-Y', strtotime($data_jurnal_header->tanggal_giro_jt)) }}</p>
                                        </div>
                                    </div>
                                @endif
                            </div>
