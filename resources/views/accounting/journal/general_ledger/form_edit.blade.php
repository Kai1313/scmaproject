                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="kode" name="kode"
                                                placeholder="Masukkan nomor jurnal umum" value="{{ isset($jurnal_header->kode_jurnal)?$jurnal_header->kode_jurnal:'' }}"
    ...
    <script>
        ...
        $(function() {
            ...
            $("#btn-generate").on("click", function() {
                ...
                details = details.filter(function(item){ return item['guid'] != "gen" })
                ...
                if (jenis == "BM" || jenis == "KM" || jenis == "PG") {
                    if (total_kredit > total_debet ) {
                        debet = parseInt(total_kredit) - parseInt(total_debet)
                        details.push({
                            guid: "gen",
                            akun: akun_slip,
                    ...
                    if (total_debet > total_kredit ) {
                        kredit = parseInt(total_debet) - parseInt(total_kredit)
                        details.push({
                            guid: "gen",
                            akun: akun_slip,
                            nama_akun: nama_akun_slip,
