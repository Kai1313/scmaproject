                    ...
                    <form id="form_detail" action="" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Debet</label>
                                    <input type="text" name="debet" id="debet" class="form-control" data-validation="[NOTEMPTY]" data-validation-message="Debet tidak boleh kosong" onfocusout="this.value=formatCurr(this.value)" value="0">
                                </div>
                                <div class="form-group">
                                    <label>Kredit</label>
                                    <input type="number" name="kredit" id="kredit" class="form-control" data-validation="[NOTEMPTY]" data-validation-message="Kredit tidak boleh kosong">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-1">
