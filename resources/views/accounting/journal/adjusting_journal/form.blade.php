                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="transaction_type" id="transaction_type" class="form-control select2">
                                        ...
                                        <option value="hutang_giro_tolak">Hutang GiroTolak</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
...
<script>
                ...
                case "hutang_giro_tolak":
                    ...
                    $('.dt-checkboxes:checked', table_hutang_giro_tolak).each(function() {
                        ...
                        details.push({
                            ...
                            nama_akun: nama_akun,
                            kode_akun: kode_akun,
                            notes: 'Jurnal Otomatis Penolakan - ' + no_giro,
                            trx: no_trx,
                            debet: formatNumberAsLocalFloat(debet),
                            kredit: 0
                        })
    ...
    function getGiroReject(ids) {
        let giro_reject_data_route = giro_reject_data_route.replace(':id', ids);
        $.ajax({
            url: current_setting_data_route,
            async: false,
            success: function(data) {
