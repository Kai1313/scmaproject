                ...
                <div class="box-header">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <a href="{{ route('transaction-adjustment-ledger-create') }}" class="btn btn-sm btn-success btn-flat pull-right mr-1"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Tambah Jurnal Penyesuaian</a>
                        </div>
                    </div>
                </div>
                @if (session('failed'))
...
<script>
    ...
    window.getActions = function(data, row) {
        ...
        action_btn += '<li><a href="' + base_url + '/transaction/adjustment_ledger/print/' + data +
