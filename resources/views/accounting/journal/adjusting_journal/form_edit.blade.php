                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="debet" id="debet" class="form-control"
                                                ...
                                                onblur="this.value=formatCurr(this.value)">
                                        </div>
                                        <div class="form-group">
                                            <label>Kredit</label>
                ...
                <div class="modal-body">
                    <form id="form-transaction" action="" method="post">
                        ...
                        <div class="row box-transaction" id="box-piutang-giro-tolak">
                            <div class="col-md-12">
                                <table id="table_piutang_giro_tolak"
                                    class="table table-bordered table-striped table-transaction" style="width:100%">
                                    <thead width="100%">
                                        <tr>
                                            <th class="text-center"></th>
                        ...
                        <div class="row box-transaction" id="box-hutang-giro-tolak">
                            <div class="col-md-12">
                                <table id="table_hutang_giro_tolak"
                                    class="table table-bordered table-striped table-transaction" style="width:100%">
                                    <thead width="100%">
                                        <tr>
                                            <th class="text-center"></th>
            ...
            switch (type) {
                ...
                case "piutang_giro":
                    ...
                    get_piutang_giro_url += '?transaction_type=' + $("#transaction_type").val() + '&supplier=' + $(
                        "#supplier_transaction").val() + '&transaction_date=' + $("#transaction_date").val() + '&slip='
                ...
                case "piutang_giro_tolak":
                    ...
                    get_piutang_giro_tolak_url += '?transaction_type=' + $("#transaction_type").val() + '&supplier=' + $(
                        "#supplier_transaction").val() + '&transaction_date=' + $("#transaction_date").val() + '&slip='
                ...
                case "hutang_giro_tolak":
                    ...
                    get_hutang_giro_tolak_url += '?transaction_type=' + $("#transaction_type").val() + '&supplier=' + $(
                        "#supplier_transaction").val() + '&transaction_date=' + $("#transaction_date").val() + '&slip='
