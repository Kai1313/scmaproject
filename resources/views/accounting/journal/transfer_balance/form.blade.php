                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="start_year" id="start_year" class="form-control select2">
                                    ...
                                    {{-- <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="end_year" id="end_year" class="form-control select2">
                                                <option value="2023">2023</option>
                                                <option value="2024">2024</option>
                                                <option value="2025">2025</option>
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <button id="btn-process" type="button"
                                            class="btn btn-flat btn-success mr-1 mb-1 pull-left"
                                            style="margin-top:25px;">Proses</button>
                                    </div>
                                </div>
                                <div class="row">
                                    {{-- <div class="col-md-3">
                                        <button id="btn-process" type="button"
                                            class="btn btn-flat btn-success mr-1 mb-1 pull-left">Proses</button>
                                    </div> --}}
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
...
@section('externalScripts')
    <script>
        ...
        //                         "Bulan Awal tidak bisa lebih besar dari Bulan Akhir", 'error')
        //                 }
        //             }
        //         }
        //     },
        ...
        $(function() {
            ...
            $("#btn-process").on("click", function() {
                ...
                let end_month = $("#end_month").val()
                // let year = $("#year").val()
                let param = "?id_cabang=" + cabang + "&start_month=" + start_month + "&end_month=" +
                    end_month
                // console.log(param);
                // let route = "{{ Route('dummy-ajax') }}"
                // route = route + param
        ...
        function save_data(route, param, step) {
            $.ajax({
                ...
                // console.log(data)
                let res = '<span><i class="fa fa-check-circle" style="color: green;"></i>' + data.message +
                    '</span>'
                let fail = '<span><i class="fa fa-times-circle" style="color: red;"></i> ' + data.message +
                    '</span>'
                if (data.result) {
                    // console.log("succeed")
