                ...
                <div class="box">
                    <div class="box-header">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <a href="{{ route('master-slip-create') }}"
                                ...
                                <a href="{{ route('master-slip-export-excel') }}" target="__blank"
                                    class="btn btn-sm btn-info btn-flat pull-right mr-1"><span
    ...
    <script>
        ...
        window.getActions = function(data, row) {
            ...
            var action_btn = '<ul id="horizontal-list"><li><a href="' + base_url + '/master/slip/show/' + data +
                ...
                base_url + '/master/slip/form/edit/' + data +
                '" class="btn btn-xs mr-1 mb-1 btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Ubah</a></li><li><button type="button" id="delete-btn" data-ids="' +
                data + '" onclick="delete_slip(' + data +
                ')" class="btn btn-xs mr-1 mb-1 btn-danger delete-btn"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Hapus</button</li></ul>';
            return action_btn;
        }
