        ...
        <table width="100%">
            ...
            <thead>
                <tr>
                    ...
                    <th style="border: #000000 solid thin;width:150px;text-align:center;font-weight:bold;">Cabang Tujuan
                    </th>
                    <th style="border: #000000 solid thin;width:150px;text-align:center;font-weight:bold;">Keterangan
                    </th>
                    <th style="border: #000000 solid thin;width:150px;text-align:center;font-weight:bold;">Jasa
                        Pengiriman</th>
                    <th style="border: #000000 solid thin;width:150px;text-align:center;font-weight:bold;">Nomor Polisi
                    </th>
            ...
            <tbody>
                @foreach ($datas as $key => $data)
                    <tr>
                        ...
                        <td style="border: #000000 solid thin;">{{ $data->nama_cabang2 }}</td>
                        <td style="border: #000000 solid thin;">{{ $data->keterangan_pindah_barang }}</td>
                        <td style="border: #000000 solid thin;">{{ $data->transporter }}</td>
                        <td style="border: #000000 solid thin;">{{ $data->nomor_polisi }}</td>
