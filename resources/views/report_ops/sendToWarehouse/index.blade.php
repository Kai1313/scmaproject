...
@section('header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Laporan Kirim Ke Gudang</li>
        </ol>
    </section>
@endsection
        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="pull-right">
                    <a href="{{ route('report_send_to_warehouse-print') }}" target="_blank"
            ...
            <div class="box-body">
                ...
                <div class="table-responsive" id="target-table-outstanding" style="display:none;">
                    <table class="table table-bordered data-table-outstanding nowrap" width="100%">
                        <thead>
                            <tr>
                                <th>Tanggal</th>
                                <th>Kode Transaksi</th>
